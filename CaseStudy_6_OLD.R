...
ListSNPs.all<-VariantFinder_GetVariantsbyGene(variant.ann)
...
impact.table.all<-VariantFinder_GetImpact(variant.ann,ListSNPs.all$dbSNP)
...
plot.impact.effect.all<-VariantFinder_PlotbyEffectImpact(variant.ann,ListSNPs.all.100,topN=3,height=20, 
...
plot.impact.effect<-VariantFinder_PlotbyEffectImpact(variant.ann,ListSNPs,topN=50,height=30, 
...
plot.impact.effect_NRAS<-VariantFinder_PlotbyEffectImpact(variant.ann,ListSNPs_NRAS,topN=50,height=30, 
