...
# <b>MMRFVariant Functions</b>


The following Figure shows the MMRFVariant functions and their input/outp. The first two columns show respectively
...
refer to the datasets described in the following Section [MMRFVariant Datasets](#Datasets)




```{r figurename8, echo=FALSE, fig.cap="MMRFVariant Functions", out.width = '99%'}
...
MMRFVariant deals with the IA15 dataset (GRCh37 reference
...
<div class="panel-heading"><a name="Datasets">MMRFVariant Datasets</a> </div>
...
MMRFVariant requires a local copy of the MMRFCoMMpass
...
# Question and issues
<hr>
Please use [Github issues](https://github.com/marziasettino/MMRFVariant/issues) if you want to file bug reports or feature requests.
